import { G as d, s as v } from './index.66fa1388.js';
const u = [];
function b(e, t = d) {
	let n;
	const s = new Set();
...
var g;
const E = ((g = globalThis.__sveltekit_n8naih) == null ? void 0 : g.base) ?? '/time-tracker';
var k;
const w = ((k = globalThis.__sveltekit_n8naih) == null ? void 0 : k.assets) ?? E,
	A = '1677799675769',
	I = 'sveltekit:snapshot',
	y = 'sveltekit:scroll',
	x = 'sveltekit:index',
	h = { tap: 1, hover: 2, viewport: 3, eager: 4, off: -1 };
function O(e) {
	let t = e.baseURI;
	if (!t) {
...
function R() {
	...
	async function s() {
		...
		if (o.ok) {
			const i = (await o.json()).version !== A;
...
const Y = { url: _({}), page: _({}), navigating: b(null), updated: R() };
export {
	x as I,
	h as P,
	y as S,
